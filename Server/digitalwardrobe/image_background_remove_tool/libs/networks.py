...
from digitalwardrobe.image_background_remove_tool.libs import strings
...
class U2NET:
    ...
    def __init__(self, name="u2net"):
        ...
        from digitalwardrobe.image_background_remove_tool.libs.u2net import U2NET as U2NET_DEEP
        from digitalwardrobe.image_background_remove_tool.libs.u2net import U2NETP as U2NETP_DEEP
        ...
        try:
            if self.torch.cuda.is_available():
                net.load_state_dict(
                    self.torch.load(os.path.join("models", name, name + '.pth')))
                net.cuda()
            else:
                net.load_state_dict(self.torch.load(os.path.join("digitalwardrobe/image_background_remove_tool/models", name, name + '.pth'), map_location="cpu"))
