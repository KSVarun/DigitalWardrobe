...
try:
    from digitalwardrobe.clothing_attributes_detection.ml_src.preprocessing \
        import make_dsets, get_label_idx_to_name, image_loader, default_loader, get_transforms
except ImportError:
    from digitalwardrobe.clothing_attributes_detection.ml_src.preprocessing \
        import make_dsets, get_label_idx_to_name, image_loader, default_loader, get_transforms
    ...
    for epoch in range(num_epochs):
        ...
        for phase in phases:
            ...
            if verbose:
                ...
                print("{} Epoch {}/{} Loss: {:.4f} Acc: {:.4f}".format(phase, epoch, num_epochs - 1, epoch_loss,
                                                                       epoch_acc))
